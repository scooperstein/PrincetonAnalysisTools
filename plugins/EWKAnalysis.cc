...
bool EWKAnalysis::Preselection(){
    ...
    *f["met_pt_JECDown_ratio"] = *f["met_shifted_JetEnDown_pt"] / *f["met_pt"] ;
    ...
    J1.SetPtEtaPhiM(f["Jet_pt"][indJet1], f["Jet_eta"][indJet1], f["Jet_phi"][indJet1], f["Jet_mass"][indJet1] * (f["Jet_pt"][indJet1] / f["Jet_pt"][indJet1] ) );
    J2.SetPtEtaPhiM(f["Jet_pt"][indJet2], f["Jet_eta"][indJet2], f["Jet_phi"][indJet2], f["Jet_mass"][indJet2] * (f["Jet_pt"][indJet2] / f["Jet_pt"][indJet2] ) );
    Hjj = J1 + J2;
    float Mjj = Hjj.M();
...
bool EWKAnalysis::Analyze(){
    ...
    *in["JetInd4"] = -1;
    ...
    TLorentzVector J1,J2,Hjj;
    J1.SetPtEtaPhiM(f["Jet_pt"][*in["JetInd1"]], f["Jet_eta"][*in["JetInd1"]], f["Jet_phi"][*in["JetInd1"]], f["Jet_mass"][*in["JetInd1"]] * (f["Jet_pt"][*in["JetInd1"]] / f["Jet_pt"][*in["JetInd1"]] ) );
    J2.SetPtEtaPhiM(f["Jet_pt"][*in["JetInd2"]], f["Jet_eta"][*in["JetInd2"]], f["Jet_phi"][*in["JetInd2"]], f["Jet_mass"][*in["JetInd2"]] * (f["Jet_pt"][*in["JetInd2"]] / f["Jet_pt"][*in["JetInd2"]] ) );
    Hjj = J1 + J2;
    *f["Mjj"] = Hjj.M();
    if (debug > 10000) {
