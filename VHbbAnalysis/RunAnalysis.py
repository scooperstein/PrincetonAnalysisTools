...
if (options.runBatch == False):
    ...
    for sample in am.samples:
        ...
        for filename in sample.files:
            ...
            content += "transfer_input_files = ../../%s,../../cfg/samples.txt,../../cfg/earlybranches.txt,../../cfg/existingbranches.txt,../../cfg/newbranches.txt,../../cfg/bdtsettings.txt,../../cfg/reg1_settings.txt,../../cfg/reg2_settings.txt,../../cfg/settings.txt,../../aux/TMVARegression_BDTG_ttbar_Nov23.weights.xml,../../aux/TMVA_13TeV_Nov23_H125Sig_0b1b2bWjetsTTbarBkg_Mjj_BDT.weights.xml,../../RunSample.py,../../../AnalysisDict.so\n" % options.configFile
            content += "Queue = 1\n"
            print content
