python ../splitSamples.py ../../VHbbAnalysis/V14_Wlnu_Jan26_forDatacards/output_allsamples.root WmnLowPt 'isWmunu&&V_pt>100&&V_pt<180'  ../systematics_Wmn.txt
python ../splitSamples.py ../../VHbbAnalysis/V14_Wlnu_Jan26_forDatacards/output_allsamples.root WmnHighPt 'isWmunu&&V_pt>180'  ../systematics_Wmn.txt
python ../splitSamples.py ../../VHbbAnalysis/V14_Wlnu_Jan26_forDatacards/output_allsamples.root WenLowPt 'isWenu&&V_pt>100&&V_pt<180'  ../systematics_Wen.txt
python ../splitSamples.py ../../VHbbAnalysis/V14_Wlnu_Jan26_forDatacards/output_allsamples.root WenHighPt 'isWenu&&V_pt>=180'  ../systematics_Wen.txt
