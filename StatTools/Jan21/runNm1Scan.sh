...
do 
    ...
    bash ../runStats.sh ../../../VHbbAnalysis/V21_Wlnu_June17_SR/output_mc.root blah ../../../VHbbAnalysis/V21_Wlnu_June17_SR/output_data.root blah 1 100 BDT_June17_$bdtvar ../../../VHbbAnalysis/V21_Wlnu_June17_SR/output_ttpowheg.root
    ## an example call for control region datacards
    bash ../runStats.sh bsl ../../../VHbbAnalysis/V21_Wlnu_June17_CR/output_mc.root blah dsf ../../../VHbbAnalysis/V21_Wlnu_June17_CR/output_data.root 1 100 BDT_June17_$bdtvar ../../../VHbbAnalysis/V21_Wlnu_June17_SR/output_ttpowheg.root
    ...
    # Calc limits
    #cd April28_$bdtvar
    cp ../June17_CR_20fb/*.txt ../June17_CR_20fb/hists_*.root .
    combineCards.py ttWmn=vhbb_ttWmn_13TeV.txt ttWen=vhbb_ttWen_13TeV.txt whfWmn=vhbb_whfWmn_13TeV.txt whfWen=vhbb_whfWen_13TeV.txt wlfWmn=vhbb_wlfWmn_13TeV.txt wlfWen=vhbb_wlfWen_13TeV.txt WmnHighPt=vhbb_WmnHighPt_13TeV.txt WenHighPt=vhbb_WenHighPt_13TeV.txt > vhbb_SR_13TeV.txt
    ...
    combine -M ProfileLikelihood --significance vhbb_SR_13TeV.txt -t -1 --expectSignal=1 | grep Significance
    ...
    combine -M MaxLikelihoodFit --expectSignal=1 -t -1 vhbb_SR_13TeV.txt --justFit | grep "Best fit r"
